...
def render_db_checks(checks: list[DbCheck], *, suite: str) -> str:
    ...
    lines: list[str] = [
        ...
        "//",
        "// `queryRows` is YOUR function: it takes SQL and returns rows. Point it at",
        "// the test database. Until it exists this file will not compile, which is",
        "// deliberate - a database check that silently does nothing is worse than none.",
        "import { expect, test } from '@playwright/test';",
        "",
